...
const PLANTS_DATA: PlantCardData[] = [
  ...
  },
  {
    ...
    damage: '2x 25',
    fireRate: '1.2 s',
    descEs: 'Dispara 2 guisantes seguidos a gran velocidad, duplicando la presión en el carril.',
    descEn: 'Fires 2 rapid peas per burst, doubling firepower along its lane.',
  },
  {
    id: 'melonpult',
    nameEs: 'Melon-pult',
    ...
    damage: 80,
    fireRate: '2.4 s',
    descEs: 'Lanza sandías pesadas por los aires infligiendo daño masivo de área a múltiples enemigos.',
    descEn: 'Launches heavy melons through the air dealing massive area damage to enemy clusters.',
  },
  {
    id: 'bonkchoy',
    nameEs: 'Bonk Choy',
    ...
    speed: 1,
    fireRate: '0.7 s',
    descEs: 'Avanza hacia la base contraria propinando puñetazos rabiosos y demoledores.',
  ...
  },
  {
    ...
    damage: 600,
    speed: 1.2,
    descEs: 'Salta y aplasta al primer enemigo que entra en su rango, aniquilándolo con impacto masivo.',
    descEn: 'Jumps and squashes the first enemy entering its range, crushing it with massive force.',
  },
  {
    id: 'potato',
    nameEs: 'Potato Mine',
    ...
    damage: 1800,
    cooldown: '20 s',
    descEs: 'Se clava bajo tierra para armarse. Al menor contacto enemigo detona causando daño masivo.',
    descEn: 'Arms underground after deployment. Detonates on enemy contact for massive explosive damage.',
  },
  {
    id: 'twinsunflower',
    ...
    descEn: 'Generates double the sun of a regular sunflower, accelerating your economy for heavy troops.',
  },
  {
    id: 'jalapeno',
    nameEs: 'Jalapeño',
    nameEn: 'Jalapeno',
    roleEs: 'Ataque de carril',
    roleEn: 'Lane Attack',
    rarity: 'rare',
    rarityLabelEs: 'RARA',
    rarityLabelEn: 'RARE',
    ...
    descEn: 'Single-use explosive plant. Ignites a raging column of fire, burning the entire lane clean.',
  },
  {
    id: 'tallnut',
    nameEs: 'Tall-nut',
  ...
  },
  {
    ...
    nameEn: 'Healer Aloe',
    roleEs: 'Soporte Curativo',
    roleEn: 'Support / Healer',
    rarity: 'epic',
    rarityLabelEs: 'ÉPICA',
    rarityLabelEn: 'EPIC',
    rarityColor: '#c084fc',
    ...
    descEn: 'Mystic healing plant. Constantly regenerates HP for wounded allied troops in its lane.',
  },
  {
    id: 'iceberg',
    nameEs: 'Lechuga Helada',
    nameEn: 'Iceberg Lettuce',
    roleEs: 'Control de Hielo',
    roleEn: 'Ice Control',
    rarity: 'legendary',
    ...
    descEn: 'Zero sun cost, single-use! Freezes all lane enemies solid for 7 full seconds.',
  },
  {
    id: 'threepeater',
    nameEs: 'Threepeater',
            ...
            <div className="landing-step-card">
              ...
              <div className="landing-step-card__body">
                ...
                <p className="landing-step-text">
                  {lang === 'es'
                    ? 'Los girasoles generan soles de 25 en 25. Cada planta tiene un coste: 25 una Potato Mine, 375 un Melon-pult. Comienzas desde cero, ¡toda la energía se gana en el campo!'
