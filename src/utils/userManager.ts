...
export const PRESET_AVATARS = [
  ...
  { id: 'kernelpult', name: 'Lanzamaíz', icon: '/game-assets/plants/kernelpult.webp' },
]
...
export function getPlayerAvatarUrl(avatarOrId?: string | null): string {
  ...
  const aliases: Record<string, string> = {
    ...
    lanzamaiz: '/game-assets/plants/kernelpult.webp',
    kernel_pult: '/game-assets/plants/kernelpult.webp',
  }
