...
export const RANKED_MATCHMAKING_TIMEOUT_SECONDS = 35
...
export const P1_COLUMNS = 7
export const P2_COLUMNS = 7
...
export const EQUIPPABLE_PLANT_ITEMS: Record<string, EquippablePlantItemDef> = {
  ...
  witch_hat: {
    ...
    equippedPlantName: 'Lanzamaíz Mágico',
    description: 'Sombrero místico para Lanzamaíz. Otorga +80 HP y permite lanzar 2 mantequillas congelantes en vez de una.',
    statBonusText: '+80 HP · 2x Mantequillas',
    applyStats: (scaled) => ({
      ...scaled,
      maxHp: scaled.maxHp + 80,
  ...
  knight_helmet: {
    ...
    description: 'Yelmo de caballero de acero forjado. Concede una armadura impenetrable de +350 HP a la Nuez.',
    statBonusText: '+350 HP · Defensa de Acero',
    applyStats: (scaled) => ({
      ...scaled,
      maxHp: scaled.maxHp + 350,
  ...
  sunflower_glasses: {
    id: 'sunflower_glasses',
    name: 'Gafas de Sol',
    emoji: '🕶️',
    targetPlantId: 'sunflower',
    equippedPlantName: 'Girasol con Gafas',
    description: 'Gafas oscuras con estilo para Girasol. Aumenta la producción de soles en combate y mazmorra.',
    statBonusText: '+5 Soles',
    applyStats: (scaled) => ({
      ...scaled,
      sprite: '/game-assets/skins/gafasgirasol.webp',
      icon: '/game-assets/skins/gafasgirasol.webp',
      packetActive: '/game-assets/skins/gafasgirasol.webp',
      packetDisabled: '/game-assets/skins/gafasgirasol.webp',
    }),
  },
  cactus_armor: {
    id: 'cactus_armor',
    name: 'Armadura de Cactus',
    emoji: '🌵',
    targetPlantId: 'chomper',
    equippedPlantName: 'Cactus Blindado',
    description: 'Armadura con púas de acero reforzado para Cactus. Otorga +15 de Daño continuo en sus ataques.',
    statBonusText: '+15 Daño',
    applyStats: (scaled) => ({
      ...scaled,
      damage: (scaled.damage ?? 35) + 15,
      sprite: '/game-assets/skins/armaduraconcactus.webp',
      icon: '/game-assets/skins/armaduraconcactus.webp',
      packetActive: '/game-assets/skins/armaduraconcactus.webp',
      packetDisabled: '/game-assets/skins/armaduraconcactus.webp',
    }),
  },
  superman_suit: {
    id: 'superman_suit',
    name: 'Capa de Superman',
    emoji: '🦸',
    targetPlantId: 'wallnut',
    equippedPlantName: 'Nuez Superman',
    description: 'Traje y capa de superhéroe legendario para la Nuez. Otorga +200 HP de resistencia heroica.',
    statBonusText: '+200 HP',
    applyStats: (scaled) => ({
      ...scaled,
      maxHp: scaled.maxHp + 200,
      sprite: '/game-assets/skins/papasuperman.webp',
      icon: '/game-assets/skins/papasuperman.webp',
      packetActive: '/game-assets/skins/papasuperman.webp',
      packetDisabled: '/game-assets/skins/papasuperman.webp',
    }),
  },
  spiderman_suit: {
    id: 'spiderman_suit',
    name: 'Traje de Spiderman',
    emoji: '🕷️',
    targetPlantId: 'wallnut',
    equippedPlantName: 'Nuez Spiderman',
    description: 'Mallas arácnidas exclusivas para la Nuez. Otorga +200 HP de resistencia trepamuros.',
    statBonusText: '+200 HP',
    applyStats: (scaled) => ({
      ...scaled,
      maxHp: scaled.maxHp + 200,
      sprite: '/game-assets/skins/papaspiderman.webp',
      icon: '/game-assets/skins/papaspiderman.webp',
      packetActive: '/game-assets/skins/papaspiderman.webp',
      packetDisabled: '/game-assets/skins/papaspiderman.webp',
    }),
  },
  batman_suit: {
    id: 'batman_suit',
    name: 'Armadura de Batman',
    emoji: '🦇',
    targetPlantId: 'wallnut',
    equippedPlantName: 'Nuez Batman',
    description: 'Armadura táctica de la noche para la Nuez. Otorga +200 HP de blindaje gótico impenetrable.',
    statBonusText: '+200 HP',
    applyStats: (scaled) => ({
      ...scaled,
      maxHp: scaled.maxHp + 200,
      sprite: '/game-assets/skins/papabatman.webp',
      icon: '/game-assets/skins/papabatman.webp',
      packetActive: '/game-assets/skins/papabatman.webp',
      packetDisabled: '/game-assets/skins/papabatman.webp',
    }),
  },
  ironman_suit: {
    id: 'ironman_suit',
    name: 'Reactor de Iron Man',
    emoji: '🦾',
    targetPlantId: 'wallnut',
    equippedPlantName: 'Nuez Iron Man',
    description: 'Armadura de titanio y reactor arc para la Nuez. Otorga +200 HP de resistencia tecnológica.',
    statBonusText: '+200 HP',
    applyStats: (scaled) => ({
      ...scaled,
      maxHp: scaled.maxHp + 200,
      sprite: '/game-assets/skins/papaironman.webp',
      icon: '/game-assets/skins/papaironman.webp',
      packetActive: '/game-assets/skins/papaironman.webp',
      packetDisabled: '/game-assets/skins/papaironman.webp',
    }),
  },
  gold_24k: {
    id: 'gold_24k',
    name: 'Bañado en Oro 24K',
    emoji: '👑',
    targetPlantId: 'wallnut',
    equippedPlantName: 'Nuez de Oro 24K',
    description: 'Bañado en oro puro de 24 quilates para la Nuez. Otorga +300 HP y reduce 2 segundos su tiempo de recarga.',
    statBonusText: '+300 HP · -2s Recarga',
    applyStats: (scaled) => ({
      ...scaled,
      maxHp: scaled.maxHp + 300,
      cooldownMs: Math.max(1000, scaled.cooldownMs - 2000),
      sprite: '/game-assets/skins/papa24k.webp',
      icon: '/game-assets/skins/papa24k.webp',
      packetActive: '/game-assets/skins/papa24k.webp',
      packetDisabled: '/game-assets/skins/papa24k.webp',
    }),
  },
  samurai_armor: {
    id: 'samurai_armor',
    name: 'Armadura Samurái',
    emoji: '⚔️',
    targetPlantId: 'garlic',
    equippedPlantName: 'Squash Samurái',
    description: 'Armadura y katana samurái para Squash. Reduce 1.5 segundos su tiempo de recarga.',
    statBonusText: '-1.5s Recarga',
    applyStats: (scaled) => ({
      ...scaled,
      cooldownMs: Math.max(1000, scaled.cooldownMs - 1500),
      sprite: '/game-assets/skins/squashsamurai.webp',
      icon: '/game-assets/skins/squashsamurai.webp',
      packetActive: '/game-assets/skins/squashsamurai.webp',
      packetDisabled: '/game-assets/skins/squashsamurai.webp',
    }),
  },
}
